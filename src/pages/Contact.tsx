          ...
          >
            <form className="card p-6 border border-light/10" onSubmit={handleSubmit}>
              ...
              <motion.button
                type="submit"
                disabled={sending}
                className={`w-full inline-flex items-center justify-center rounded-xl px-6 py-3 font-semibold text-white shadow-lg transition-all ${sending ? 'bg-gray-400 cursor-not-allowed' : 'bg-gradient-to-r from-accent via-secondary to-accent hover:shadow-accent/30'}`}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
